...
class NotificationHelper {
  ...
  static Future<void> showNotification({required String? title, required String? body, String? payload}) async {
    showTextNotification(title: title, body: body, payload: payload);
  }

  static Future<void> showTextNotification({required String? title, required String? body, String? payload}) async {
