...
class FileUpload {
  ...
  Future<Response> uploadImage({required File file, required String keyName, required String url}) async {
    String fileName = file.path.split('/').last;
    FormData formData = FormData.fromMap({keyName: await MultipartFile.fromFile(file.path, filename: fileName)});
